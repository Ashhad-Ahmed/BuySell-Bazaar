...
const MobileApps: React.FC<MobileAppsProps> = ({ data, isLoading }) => {
    ...
    const handleSeeMore = () => {
        navigation.navigate('AllAds', { title: 'Mobile Ads', category_id: 11 });
    };
        ...
        return (
            <View>
                ...
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyText}>No mobile ads to show right now.</Text>
                </View>
            </View>
        );
    }
